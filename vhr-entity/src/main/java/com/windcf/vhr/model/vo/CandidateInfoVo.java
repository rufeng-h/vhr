...
public class CandidateInfoVo extends AbstractUserInfoVo {
    public CandidateInfoVo(Candidate candidate) {
        super(candidate.getCandId(), candidate.getCandName(), candidate.getCandAvatar(), candidate.getCandEmail(), candidate.getCandPhone(), candidate.getCandLastLogin(), UserTypeEnum.CANDIDATE);
    }
}
